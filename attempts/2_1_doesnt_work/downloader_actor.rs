...
impl DownloaderActor {
    ...
    async fn handle_message(&mut self, msg: ActorMessage) {
        ...
        } = msg
        {
            ...
            //todo instead of responding now publish a new job
...
impl DownloaderActorHandle {
    ...
    pub async fn download_data(
        ...
        //todo fucking weird - as soon as I use this to send data... something somewhere panics
        // I am virtually certain it's an await problem somwhere
    }
}
